...
|---|---|---|---|---|---|
| 기본 | `banner-1~6.jpg` | 2000 x 850 | 2.35:1 | demo-1·2·3 | cover (꽉 참) |
| 와이드 2:1 | `banner-2x1-1~6.jpg` | 2000 x 1000 | 2:1 | demo-4·5·6·9 | contain (전체 표시) |

> `banner-2x1-*`는 `banner-*`(2.35:1) 원본을 좌우 센터크롭한 **동일 사진**입니다.
> demo-7·8은 자체 배너(동영상 등)를 쓰고, demo-10은 배너가 없어 위 세트와 무관합니다.

사진은 **따뜻한 뉴트럴/제품·라이프스타일 무드의 실사진 6종**(무료·상업적 이용 가능, 출처표기 불필요)입니다.
