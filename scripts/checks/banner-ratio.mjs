...
// 그러면 한 줄 주석 지우기가 줄 끝에서 멈추고, 아래 '안쪽 상자는 바깥을 그대로 채운다' 처럼
// 줄바꿈을 직접 적은 정규식이 빗나간다. 파일은 멀쩡한데 검사만 빨간불이 된다(2026-08-28).
// 더 나쁜 쪽은 '없음' 을 확인하는 검사다 — 그건 조용히 통과해 버려서 눈치채지 못한다.
const 주석뺀 = (t) => String(t).split(String.fromCharCode(13)).join('')
