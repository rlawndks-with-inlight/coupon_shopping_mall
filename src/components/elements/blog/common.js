...
export const Seller = props => {
    ...
    const { blog_demo_num = 0 } = themeDnsData
    const returnSellerCard = () => {
        if (blog_demo_num == 1) return <Seller1 {...props} />
        else if (blog_demo_num == 2) return <Seller2 {...props} />
        else if (blog_demo_num == 3) return <Seller3 {...props} />
        else if (blog_demo_num == 4) return <Seller4 {...props} />
        else if (blog_demo_num == 5) return <Seller5 {...props} />
        /*else if (blog_demo_num == 6) return <Seller6 {...props} />
        else if (blog_demo_num == 7) return <Seller7 {...props} />*/
...
export const Item = props => {
    ...
    const { blog_demo_num = 0 } = themeDnsData
    const returnSellerCard = () => {
        if (blog_demo_num == 1) return <Item1 {...props} />
        else if (blog_demo_num == 2) return <Item2 {...props} />
        else if (blog_demo_num == 3) return <Item3 {...props} />
        else if (blog_demo_num == 4) return <Item4 {...props} />
        else if (blog_demo_num == 5) return <Item5 {...props} />
        /*else if (shop_demo_num == 6) return <Item6 {...props} />
        else if (shop_demo_num == 7) return <Item7 {...props} />*/
        else return <Item2 {...props} />
    }
    return <>{returnSellerCard()}</>
}
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Button variant='outlined' onClick={() => {
                                                ...
                                                // 목록 응답에는 옵션 내용이 없어 담아도 '무엇을 산 것인지'가 안 남는다.
