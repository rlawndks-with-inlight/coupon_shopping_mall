...
//   쇼핑몰형 10                 빈 컴포넌트
//   블로그형 (전부)             헤더에 카테고리 메뉴가 없다
//     2·3 은 categories state 와 hover 표까지 만들지만 JSX 에 내보내지 않는다.
//     코드가 있으니 그리는 줄 알기 쉬운데, 화면에는 안 나온다 — 실제로 그렇게 잘못 읽었다.
//     판정은 '값을 준비하나' 가 아니라 '화면에 나오나' 로 한다.
