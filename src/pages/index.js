...
//
// ⚠ 4번 항목 표현 주의. transactions.card_num(varchar 20)이 실재하고
//   결제 확정 경로 3곳이 여기에 카드정보를 써 넣는다(2023년부터 살아 있는 코드).
//   그러니 '결제정보를 저장하지 않는다'고 쓰면 거짓이다.
//   '전체 카드번호는 저장하지 않습니다'는 그 값이 마스킹된 형태일 때만 참이다 —
//   컬럼에 실제로 들어가는 값을 확인하기 전에는 이 문구를 더 세게 바꾸지 말 것.
const TRUST = [
