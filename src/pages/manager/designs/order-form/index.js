    ...
    return (
        <Stack spacing={2}>
            <Alert severity="info" sx={{ fontSize: '0.85rem' }}>
                ...
                {/* 메뉴에서 내렸으므로 주소로 들어온 사람에게 그 사실을 알려야 한다.
                    안 알리면 '왜 메뉴에 없지'를 혼자 헤매게 된다. */}
                <b>이 화면은 지금 메뉴에 없습니다</b> — 예약형 가맹점이 하나뿐이라 돌려쓸 상대가 없어서
                내려둔 상태입니다. 여기서 서식을 만들면 가맹점 상품등록에 &lsquo;불러오기&rsquo; 버튼이 바로 생깁니다.<br />
