          ...
          {router.query?.type == 0 || type == 0 ?
            themeDnsData?.id != 74 ?
              ...
              <>
                ...
                <SubTitle>제 1 조 (목적)</SubTitle>
                <Text>
                  이 약관은 [{themeDnsData?.company_name}] (이하 "회사")가 운영하는 온라인 쇼핑몰(이하 "몰")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용하는 고객(이하 "회원" 또는 "이용자")과 회사 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
                </Text>

                <SubTitle>제 2 조 (정의)</SubTitle>
                <Text>
                  1. "몰" : 회사가 운영하는 온라인 쇼핑몰 웹사이트를 의미합니다.<br />
                  2. "이용자" : 몰에 접속하여 본 약관에 따라 서비스를 이용하는 자를 의미합니다.<br />
                  3. "회원" : 몰에 가입하여 지속적으로 서비스를 이용하는 자를 의미합니다.<br />
                  4. "비회원" : 회원가입 없이 서비스를 이용하는 자를 의미합니다.<br />
                  5. "판매자" : 몰에 상품을 등록하고 판매하는 자를 의미합니다.<br />
                  6. "상품" : 몰에서 판매되는 재화 또는 용역을 의미합니다.<br />
                </Text>

                <SubTitle>제 3 조 (약관의 게시 및 개정)</SubTitle>
                <Text>
                  1. 본 약관은 몰의 초기 화면에 게시되며, 이용자가 동의하는 경우 효력이 발생합니다.<br />
                  2. 회사는 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있으며, 개정 시 몰을 통해 공지합니다.<br />
                  3. 이용자가 개정 약관에 동의하지 않을 경우, 이용계약을 해지할 수 있으며, 계속 이용 시 개정 약관에 동의한 것으로 간주됩니다.<br />
                </Text>
                ...
                <SubTitle>제 4 조 (서비스 제공 및 변경)</SubTitle>
                <Text>
                  1. 회사는 다음과 같은 서비스를 제공합니다.<br /><br />
                  <span style={{ marginLeft: '1rem' }}>· 상품 정보 제공 및 구매 계약의 체결</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 결제 수단 제공 및 결제 처리</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 상품 배송 및 교환·환불 서비스</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 판매자 입점 및 판매 지원 서비스</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 기타 회사가 정하는 서비스</span><br /><br />
                  2. 회사는 상품 품절 또는 기술적 사유 등으로 인해 서비스 내용을 변경할 수 있으며, 이에 대해 사전 공지합니다.
                </Text>
                <SubTitle>제 5 조 (회원가입 및 탈퇴)</SubTitle>
                <Text>
                  1. 이용자는 몰에서 제공하는 절차에 따라 회원가입을 할 수 있으며, 회사는 가입을 승인할 수 있습니다.<br />
                  2. 회원은 언제든지 탈퇴를 요청할 수 있으며, 회사는 즉시 탈퇴 처리합니다.<br />
                  3. 회원이 다음 각 호에 해당하는 경우, 회사는 회원자격을 제한하거나 박탈할 수 있습니다.<br /><br />
                  <span style={{ marginLeft: '1rem' }}>· 허위 정보를 제공한 경우</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 몰을 부정한 방법으로 이용한 경우</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 법령 또는 본 약관을 위반한 경우</span><br />
                </Text>
                ...
                <SubTitle>제 6 조 (회사의 의무)</SubTitle>
                <Text>
                  1. 회사는 특별한 사정이 없는 한 이용자가 신청한 서비스를 이용할 수 있도록 합니다.<br />
                  2. 회사는 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화, 용역을 제공하는데 최선을 다하여야 합니다.<br />
                  3. 회사는 이용계약체결, 계약사항의 변경 해지 등에 있어 회원에게 안정적 서비스를 제공하도록 노력합니다.<br />
                </Text>
                <SubTitle>제 7 조 (회원의 의무)</SubTitle>
                <Text>
                  1. 회원은 가입 신청 또는 정보 변경 시 허위내용을 등록하거나 타인 등의 정보를 등록할 경우 이와 관련된 모든 권리를 주장할 수 없습니다.<br />
                  2. 회사의 업무에 방해가 되는 행위, 회사의 명예를 손상시키는 행위, 타인에게 피해를 주는 행위는 해서는 안 됩니다.<br />
                  3. 제3자의 저작권 등 지적재산권에 대한 침해 서비스 운영의 방해 행위 혹은 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위는 금합니다.<br />
                  4. 회원은 서비스의 이용권한, 기타 이용계약상의 지위를 타인에게, 양도증여 할 수 없으며 이를 담보로서 제공할 수 없고, 제3자에게 ID 및 비밀번호를 이용하게 해서는 아니됩니다.<br />
                  5. 회원은 관계법령, 이 약관의 규정, 이용안내 및 주의사항 등 회사가 통지하는 사항을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 아니됩니다.<br />
                  6. 회원은 서비스를 이용하여 얻은 정보를 회사의 사전 승낙 없이 이를 타인에게 제공할 수 없습니다.<br />
                  7. 회원은 회사 서비스 이용과 관련 다음 각 호의 행위를 하여서는 아니 되고, 이를 위반할 시 민 형사상 법적 조치를 받을 수 있습니다.<br /><br />

                  <span style={{ marginLeft: '1rem' }}>- 범죄행위를 목적으로 하거나 기타 범죄행위와 관련된 행위</span><br />
                  <span style={{ marginLeft: '1rem' }}>- 다른 회원의 아이디(ID)를 부정사용하는 행위</span><br />
                  <span style={{ marginLeft: '1rem' }}>- 선량한 풍속, 기타 사회질서를 해하는 행위</span><br />
                  <span style={{ marginLeft: '1rem' }}>- 타인의 명예를 훼손하거나 모욕하는 행위</span><br />
                  <span style={{ marginLeft: '1rem' }}>- 해킹행위 또는 컴퓨터바이러스의 유포행위</span><br />
                  <span style={{ marginLeft: '1rem' }}>- 관계법령에 위배되는 행위</span><br />
                  <span style={{ marginLeft: '1rem' }}>- 기타 회사가 서비스 운영상 부적절하다고 판단하는 행위</span><br />
                </Text>

                <SubTitle>제 8 조 (판매자의 권리 및 의무)</SubTitle>
                <Text>
                  1. 판매자는 회사가 제공하는 절차에 따라 상품을 등록하고 판매할 수 있습니다.<br />
                  2. 판매자는 상품의 정보(가격, 재고, 상세설명 등)를 정확하게 기재해야 하며, 허위 정보로 인해 발생하는 문제에 대한 책임을 집니다.<br />
                  3. 판매자는 이용자의 주문에 따라 정해진 기간 내에 상품을 발송해야 합니다.<br />
                  4. 판매자는 이용자의 반품 및 환불 요청을 회사의 정책과 관련 법령에 따라 처리해야 합니다.<br />
                  5. 판매자는 회사의 운영 정책 및 가이드라인을 준수해야 하며, 이를 위반할 경우 판매 자격이 제한될 수 있습니다.<br />
                  6. 판매자는 이용자의 개인정보를 임의로 수집하거나 활용할 수 없으며, 개인정보 보호 관련 법령을 준수해야 합니다.<br />
                </Text>

                <SubTitle>제 9 조 (판매 수수료 및 정산)</SubTitle>
                <Text>
                  1. 회사는 판매자에게 일정 비율의 판매 수수료를 부과할 수 있으며, 해당 수수료율은 별도로 공지합니다.<br />
                  2. 판매자의 매출 정산은 회사의 정산 주기에 따라 이루어지며, 정산 일정 및 방식은 판매자에게 사전 안내됩니다.<br />
                  3. 판매자가 허위 주문, 부당한 거래 등을 통해 매출을 조작한 경우, 회사는 해당 금액의 정산을 보류하거나 취소할 수 있습니다.<br />
                </Text>

                <SubTitle>제 10 조 (상품 주문 및 계약 성립)</SubTitle>
                <Text>
                  1. 이용자는 몰에서 제공하는 절차에 따라 상품을 주문할 수 있으며, 회사는 결제 완료 후 주문을 승인합니다.<br />
                  2. 회사는 이용자의 주문 신청에 대해 다음 각 호의 사유로 승인을 거절할 수 있습니다.<br /><br />
                  <span style={{ marginLeft: '1rem' }}>· 허위 정보 기재</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 몰을 부정한 방법으로 이용한 경우</span><br />
                  <span style={{ marginLeft: '1rem' }}>· 법령 또는 본 약관을 위반한 경우</span><br />
                </Text>

                <SubTitle>제 4 장 결제 및 배송</SubTitle>

                <SubTitle>제 11 조 (결제방법)</SubTitle>
                <Text>
                  이용자는 다음 각 호의 결제 방법을 이용할 수 있습니다.<br /><br />

                  <span style={{ marginLeft: '1rem' }}>1. 신용카드, 체크카드</span><br />
                  <span style={{ marginLeft: '1rem' }}>2. 무통장 입금</span><br />
                  <span style={{ marginLeft: '1rem' }}>3. 휴대폰 결제</span><br />
                  <span style={{ marginLeft: '1rem' }}>4. 기타 회사가 제공하는 방법</span><br />
                </Text>
                <SubTitle>제 12 조 (배송 및 환불)</SubTitle>
                <Text>
                  1. 회사 또는 판매자는 이용자의 결제 완료 후 정해진 기간 내에 상품을 배송합니다.<br />
                  2. 배송 지연 시 회사 또는 판매자는 이용자에게 사전 통보합니다.<br />
                  3. 환불 및 교환은 관련 법령 및 회사의 정책에 따릅니다.<br />
                </Text>

                <SubTitle>제 5 장 책임 및 개인정보보호</SubTitle>

                <SubTitle>제 13 조 (판매자의 책임 및 제재)</SubTitle>
                <Text>
                  1. 판매자가 고의적으로 허위 정보를 제공하거나, 부정한 방법으로 거래를 유도할 경우, 회사는 해당 판매자의 이용을 제한하거나 거래를 취소할 수 있습니다.<br />
                  2. 판매자가 지속적으로 고객 불만을 유발하거나, 소비자 보호법을 위반하는 경우, 회사는 판매 자격을 정지하거나 박탈할 수 있습니다.<br />
                  3. 판매자가 배송 지연, 반품/환불 지연 등으로 인해 고객 불만이 발생할 경우, 회사는 해당 문제를 해결하기 위해 판매자에게 시정을 요구할 수 있으며, 미이행 시 제재 조치를 취할 수 있습니다.<br />
                </Text>

                <SubTitle>제 14 조 (개인정보 보호)</SubTitle>
                <Text>
                  1. 회사는 이용자의 개인정보를 보호하기 위해 관련 법령을 준수합니다.<br />
                  2. 회사는 이용자의 동의 없이 개인정보를 제3자에게 제공하지 않습니다.<br />
                  3. 개인정보 보호와 관련된 자세한 내용은 회사의 개인정보처리방침에 따릅니다.<br />
                </Text>

                <SubTitle>제 15 조 (책임 제한)</SubTitle>
                <Text>
                  1. 회사는 천재지변, 시스템 장애 등 불가항력적인 사유로 인해 서비스 제공이 어려운 경우 책임을 지지 않습니다.<br />
                  2. 이용자가 자신의 부주의로 인해 발생한 손해에 대해서는 회사가 책임을 지지 않습니다.<br />
                  3. 판매자의 고의 또는 과실로 인해 발생한 문제에 대해서는 해당 판매자가 책임을 집니다.<br />
                </Text>

                <SubTitle>제 6 장 손해배상 및 기타</SubTitle>

                <SubTitle>제 16 조 (손해배상)</SubTitle>
                <Text>
                  1. 회사는 제공되는 서비스와 관련한 증권거래를 함에 있어, 정보내용에 대한 최종 판단 및 결정은 회원 본인이 하여야 하므로 그에 따른 제반 손실 등에 대한 책임을 지지 않습니다.<br />
                </Text>
                <SubTitle>제 17 조 (면책조항)</SubTitle>
                <Text>
                  1. 회사는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공 중지에 대한 책임이 면제됩니다.<br />
                  2. 회사는 서비스용 설비의 정기검사 보수 교체 등 공사에 의한 부득이한 사유로 발생한 손해에 대한 책임은 면제됩니다.<br />
                </Text>
                <SubTitle>제 18 조 (저작권귀속 및 이용제한)</SubTitle>
                <Text>
                  1. 회사가 작성한 서비스에 관한 저작권 및 기타 지적 재산권은 회사에 귀속됩니다.<br />
                  2. 회원이 작성한 게시물에 대한 저작권은 이를 게시한 회원에 있습니다. 단, 회원이 작성한 게시물의 2차적 저작물 작성권은 회사에게 있으며, 회사는 회원의 게시물을 홍보 등의 목적으로 이용할 수 있습니다.<br />
                  3. 회원은 서비스를 이용함으로써 얻은 정보를 회사의 사전승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용 하거나, 제 3자에게 이용하게 하여서는 안됩니다.<br />
                </Text>
                <SubTitle>제 19 조 (분쟁해결 및 관할법원)</SubTitle>
                <Text>
                  1. 회사와 이용자 또는 판매자 간 발생한 분쟁은 원만하게 해결하기 위해 노력합니다.<br />
                  2. 분쟁이 해결되지 않을 경우, 동 분쟁으로 인하여 소송이 제기될 경우 동 소송은 회사의 본사소재지를 관할하는 법원의 관할로 합니다.<br />
                </Text>

                <Text>
                  본 약관은 [{themeDnsData?.establish_date}]부터 시행합니다.<br />
                </Text>
              </>
            :
            <>
            </>}
          {router.query?.type == 1 || type == 1 ?
            <>
              <SubTitle></SubTitle>
              <Text>
