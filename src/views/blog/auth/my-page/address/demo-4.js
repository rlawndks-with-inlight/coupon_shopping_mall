...
const Demo4 = (props) => {
    ...
    const onSubmitAddress = async () => {
        ...
        let result;
        if (editId) {
            result = await apiManager('user-addresses', 'update', {
                ...payload,
                id: editId,
            })
        } else {
    ...
    return (
        <>
            ...
            <Wrappers>
                        ...
                        <ContentContainer>
                            <>
                                {addressList.length == 0 &&
                                    <div style={{ textAlign: 'center', padding: '3rem 0', color: 'grey' }}>
                                        등록된 배송지가 없습니다.
                                    </div>
                                }
                ...
                {activeStep == 1 &&
                    <>
                        <Title>{editId ? '배송지 변경' : '배송지 추가'}</Title>
                        {isOpenPost ?
                            <DaumPostcode
                            ...
                            <>
                                ...
                                <Button variant='contained' style={{ height: '56px', fontSize: 'large', marginTop: '1rem' }} onClick={() => { onSubmitAddress() }}>완료</Button>
                            </>
                        }
                    </>
                }
