...
import { Item1, Seller1 } from 'src/components/elements/blog/demo-1';
            ...
            <ItemContainer>
                {data?.list && data?.list.slice(0, 8).map((item, idx) => (
                    <>
                        {data?.type == 'seller' &&
                            <>
                                <Seller1 item={item} router={router} type={data?.type} />
                            </>}
                        {data?.type == 'items' &&
                            <>
                                <Item1 item={item} router={router} type={data?.type} />
                            </>}
                    </>
                ))}
            </ItemContainer>
