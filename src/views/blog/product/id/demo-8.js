...
const Demo8 = () => {
  ...
  return (
    <Wrapper>
      ...
      <ButtonGrid>
        <BtnCell disabled={!purchasable} style={purchasable ? undefined : { opacity: 0.45, cursor: 'not-allowed' }} onClick={handleAddCart}>Cart</BtnCell>
        <BtnCell $primary disabled={!purchasable} style={purchasable ? undefined : { opacity: 0.45, cursor: 'not-allowed' }} onClick={() => startBuyNow(item, selectProductGroups, router)}>Buy Now →</BtnCell>
      </ButtonGrid>
