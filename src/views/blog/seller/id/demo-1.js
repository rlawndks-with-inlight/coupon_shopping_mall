...
import { commarNumber, getDownToTopChildren } from 'src/utils/function';
...
const Demo1 = (props) => {
    ...
    // 상품 카드의 담기/구매 버튼 클릭 → 선택된 실제 상품을 상태에 저장하고 드로어 오픈
                ...
                <SelectContainer>
                    ...
                    <DrawerBox style={{ borderBottom: 'none' }}>
                        <Row style={{ justifyContent: 'space-between' }}>
                            ...
                            <div>
                                <span style={{ color: 'red' }}>{commarNumber(selectedItem?.product_sale_price ?? 0)}</span>원
                            </div>
                        </Row>
                        <Row style={{ justifyContent: 'space-between' }}>
                            <Row style={{ width: '150px', justifyContent: 'space-between', alignItems: 'center', padding: '0.25rem' }}>
                            ...
                            <div>
                                <span style={{ color: 'red' }}>{commarNumber(selectedItem?.delivery_fee ?? 0)}</span>원
                            </div>
                        </Row>
                        <Row style={{ justifyContent: 'space-between' }}>
                            <Row style={{ width: '150px', justifyContent: 'space-between', alignItems: 'center', padding: '0.25rem' }}>
