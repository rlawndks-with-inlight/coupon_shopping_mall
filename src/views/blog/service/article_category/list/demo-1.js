...
import { Tabs, Tab, Accordion, AccordionSummary, AccordionDetails, Iconify, Typography } from '@mui/material';
                            ...
                            <>
                                ...
                                >
                                    <AccordionSummary expandIcon={<Iconify icon="eva:arrow-ios-downward-fill" />}>
                                        <Typography variant="subtitle1">{item.inquiry_title} {item.inquiry_detail} {item.answer ? "(답변 완료)" : "(답변 대기중)"}</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
