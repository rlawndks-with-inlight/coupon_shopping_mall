    ...
    return (
        <>
            <Wrappers style={{
                ...
                <Sellers sellers={[...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,...column?.list,]} router={router} />
            </Wrappers>
        </>
    )
}
