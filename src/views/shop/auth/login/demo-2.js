...
margin-bottom: 10vh;
`
const HoverText = styled.div`//아이디, 비밀번호 찾기 부분
padding: 0 1rem;
  ...
  return (
    <>
      <Wrappers>
        ...
        />
        <TextField
          label='비밀번호'//비밀번호 칸 안에 비밀번호라고 적힌거
          onChange={(e) => {
        ...
        <Row style={{ margin: '2rem auto' }}>
          <HoverText style={{ borderRight: `1px solid ${themeObj.grey[500]}` }} presetsColor={presetsColor} onClick={() => { router.push(`/shop/auth/find-info?type=0`) }}>아이디 찾기</HoverText>
