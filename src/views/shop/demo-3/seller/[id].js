  ...
  return (
    <>
      <BannerImg style={{
        ...
        <BannerOverlay />
        <Title style={{ marginTop: 'auto', color: '#fff', position: 'relative', zIndex: 1, letterSpacing: '0.04em' }}>{item?.nickname}</Title>
        <SubTitle>{item?.seller_name}</SubTitle>
        <Row style={{ margin: '1rem', marginBottom: 'auto', position: 'relative', zIndex: 1 }}>
      ...
      <ContentWrapper>
        ...
        <SectionTitle style={{ marginTop: '38px' }}>
