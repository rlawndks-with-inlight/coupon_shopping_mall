        ...
        <BottomContent>
          ...
          <RowHome>
            ...
            <div style={{ marginLeft: '3rem' }}>
              ...
              <br />
              <div style={{ fontSize: '13px', fontFamily:'Noto Sans KR' }}>
              ...
              <br /><br /><br /><br />
              <Row style={{ fontSize: '14px', fontWeight: 'bold', fontFamily:'Noto Sans KR' }}>
                인스파이어점
              </Row>
              <Row style={{ fontSize: '12px', fontFamily:'Noto Sans KR' }}>
